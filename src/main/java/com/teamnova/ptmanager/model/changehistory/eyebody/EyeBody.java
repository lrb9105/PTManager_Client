...
public class EyeBody implements Serializable {
    ...
    public EyeBody(String eyeBodyChangeId, String userId, String creDate, String creDateTime, String fileCreDateTime, String savePath, String delYn) {
